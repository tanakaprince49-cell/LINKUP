...
// Payonify instead: AuthContext folds the webSubscriptions/{uid} entitlement into
// the profile (see withWebEntitlements), so this one expression is true for a
// Play subscriber on Android AND for a paid-up Payonify subscriber on web — and
